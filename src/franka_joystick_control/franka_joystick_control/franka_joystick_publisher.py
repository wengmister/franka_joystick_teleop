...
class FrankaJoystickPublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter('max_rate_linear', 2.0)   # slower max change rate  
        self.declare_parameter('max_rate_angular', 2.0)  # slower max change rate
        self.declare_parameter('release_decel_factor', 0.3)  # Much slower deceleration on release
